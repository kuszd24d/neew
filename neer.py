...
def veletlen_talalkozas(talalkozasok):
    """Véletlenszerű találkozás generálása a fennmaradó találkozások közül."""
    return talalkozasok.pop(random.randint(0, len(talalkozasok) - 1))
...
def jatek():
    ...
    for lepes in range(1, len(talalkozasok) + 1):
        lassu_szoveg(f"\nUtazás {lepes}. szakasza...\n")
        talalkozas_tipusa = veletlen_talalkozas(talalkozasok)
    ...
    lassu_szoveg("\n🏠 Végül, minden próba után, elérsz Ithakába!\n")
